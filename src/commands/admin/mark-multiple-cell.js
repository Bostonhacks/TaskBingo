...
module.exports = {
    ...
    run: async ({interaction, client, handler}) => {
      ...
      try {
        ...
        console.log(interaction.options.get('cell-number').value)
        let cellNumbers = interaction.options.get('cell-number').value.split(',').map(num => Number(num.trim()));
